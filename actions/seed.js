...
const ACCOUNT_ID = "account-id79912724-254e-4bbc-8abc-6faf612e2808";
const USER_ID = "53aa39cf-3653-42eb-8635-d2271fdf6a1d";
...
export async function seedTransactions() {
  try {
    ...
    await db.$transaction(async (tx) => {
      ...
      // Ensure seed account exists and belongs to the seed user
